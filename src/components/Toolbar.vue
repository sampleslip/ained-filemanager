  ...
  <div class="flex justify-between items-center py-1 text-sm">
    <div class="flex text-center" v-if="!searchQuery.length">
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
               class="h-9 w-9 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 p-2 rounded dark:stroke-white dark:hover:text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
                :class="(selectedItems.length == 1) ? 'cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 rounded dark:stroke-white dark:hover:text-indigo-500' : 'stroke-gray-200  dark:stroke-gray-700'"
        ...
        <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                 :class="(selectedItems.length) ? 'cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 rounded dark:stroke-white dark:hover:text-indigo-500' : 'stroke-gray-200  dark:stroke-gray-700'"
                 class="h-9 w-9 m-auto p-2" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 p-2 rounded dark:stroke-white dark:hover:text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
    ...
    <div class="flex text-center items-center justify-end">
         ...
         <div :aria-label="t('Toggle Full Screen')" data-microtip-position="bottom-left" role="tooltip"
               @click="setFullScreen">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 p-2 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 rounded dark:stroke-white dark:hover:text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
               :class="(!searchQuery.length) ? 'cursor-pointer  stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 rounded  dark:stroke-white dark:hover:text-indigo-500' : 'stroke-gray-200  dark:stroke-gray-700'"
