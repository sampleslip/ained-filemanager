  ...
  <div class="flex justify-between items-center py-1 text-sm">
    <div class="flex text-center" v-if="!searchQuery.length">
        ...
        <div class="mx-1.5"
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
                :class="(selectedItems.length == 1) ? 'cursor-pointer hover:stroke-indigo-200 hover:bg-indigo-200 rounded dark:stroke-gray-400 dark:hover:stroke-gray-300' : 'stroke-gray-200  dark:stroke-gray-700'"
        ...
        <div class="mx-1.5"
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                 :class="(selectedItems.length) ? 'cursor-pointer hover:stroke-indigo-200 hover:bg-indigo-200 rounded dark:stroke-gray-400 dark:hover:stroke-gray-300' : 'stroke-gray-200  dark:stroke-gray-700'"
                 class="h-10 w-10 m-auto p-2" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
    ...
    <div class="flex text-center items-center justify-end">
         ...
         <div class="mx-1.5" :aria-label="t('Toggle Full Screen')" data-microtip-position="bottom-left" role="tooltip"
               @click="setFullScreen">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 p-2 m-auto cursor-pointer stroke-gray-500 hover:stroke-cyan-700 dark:stroke-gray-400 dark:hover:stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
