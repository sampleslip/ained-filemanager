  ...
  <div class="flex justify-between items-center py-1 text-sm">
    <div class="flex text-center" v-if="!searchQuery.length">
        <div class="mx-1.5"
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
               class="h-10 w-10 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 p-2 rounded dark:stroke-gray-400 dark:hover:stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div class="mx-1.5"
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
               ...
               class="h-10 w-10 m-auto p-2" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div class="mx-1.5"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 p-2 rounded dark:stroke-gray-400 dark:hover:stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
    ...
    <div class="flex text-center" v-else>
      <div class="pl-2"> {{ t('Search results for') }} <span class="dark:bg-gray-700 text-base px-2 p-2 bg-gray-100 rounded">{{ searchQuery }}</span></div>
       <svg
            class="animate-spin  p-2 h-10 w-10 text-white ml-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"  v-if="isLoading()">
    ...
    <div class="flex text-center items-center justify-end">
         ...
         <div class="mx-1.5" :aria-label="t('Toggle Full Screen')" data-microtip-position="bottom-left" role="tooltip"
               @click="setFullScreen">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 p-2 m-auto cursor-pointer stroke-gray-500 hover:stroke-indigo-500 hover:bg-indigo-200 rounded dark:stroke-gray-400 dark:hover:stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
        ...
        <div class="mx-1.5"
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
               ...
               class="h-10 w-10 p-2 m-auto" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
